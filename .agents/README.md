# skeptic Agent Automation

This `.agents` directory provides reusable skill assets for operating `skeptic` across rule management, threat intel ingestion, and documentation workflows.
